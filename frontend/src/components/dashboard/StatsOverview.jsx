    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
      ...
      <div className="bg-surface-container-lowest rounded-xl p-5 shadow-[0_4px_20px_rgba(2,36,72,0.03)] border border-white">
        <div className="flex justify-between items-start mb-4">
          <p className="text-xs font-bold text-on-surface-variant uppercase tracking-widest">Ideas Evaluated</p>
          <span className="material-symbols-outlined text-secondary text-xl">lightbulb</span>
        </div>
        <div className="flex items-end justify-between">
          <div>
            <h3 className="text-3xl font-bold text-primary leading-none">12</h3>
            <p className="text-[10px] text-green-600 font-bold mt-2 flex items-center gap-1">
              <span className="material-symbols-outlined text-xs">trending_up</span> +14% vs last week
            </p>
          </div>
      ...
      <div className="bg-surface-container-lowest rounded-xl p-5 shadow-[0_4px_20px_rgba(2,36,72,0.03)] border border-white">
        <div className="flex justify-between items-start mb-4">
          ...
          <span className="w-6 h-6 bg-error rounded-full flex items-center justify-center text-[10px] font-bold text-white">5</span>
        </div>
        <div className="flex items-end justify-between">
          <h3 className="text-3xl font-bold text-primary leading-none">05</h3>
          <div className="p-2 bg-error-container/20 rounded-lg">
            <span className="material-symbols-outlined text-error" data-icon="assignment_late">assignment_late</span>
          </div>
        </div>
        <p className="text-[10px] text-on-surface-variant font-medium mt-3 italic">Next: Project Alpha Review (14:00)</p>
      </div>
      ...
      <div className="bg-surface-container-lowest rounded-xl p-5 shadow-[0_4px_20px_rgba(2,36,72,0.03)] border border-white">
        ...
        <div className="flex items-end justify-between">
          <div>
            <h3 className="text-3xl font-bold text-primary leading-none">02</h3>
            <p className="text-[10px] text-secondary font-bold mt-2">Next: 11:30 AM</p>
          </div>
      ...
      <div className="bg-surface-container-lowest rounded-xl p-5 shadow-[0_4px_20px_rgba(2,36,72,0.03)] border border-white">
        <div className="flex justify-between items-start mb-4">
          <p className="text-xs font-bold text-on-surface-variant uppercase tracking-widest">Health Score</p>
          <span className="material-symbols-outlined text-green-600 text-xl">verified</span>
        </div>
        <div className="flex items-center justify-between">
          <h3 className="text-3xl font-bold text-primary leading-none">78<span className="text-sm font-medium text-slate-400">/100</span></h3>
          <div className="relative w-12 h-12 flex items-center justify-center">
            <svg className="w-full h-full -rotate-90">
              <circle cx="24" cy="24" fill="transparent" r="20" stroke="#f2f4f6" strokeWidth="4"></circle>
              <circle cx="24" cy="24" fill="transparent" r="20" stroke="#22c55e" strokeDasharray="125.6" strokeDashoffset="27.6" strokeWidth="4"></circle>
            </svg>
            <span className="absolute text-[10px] font-bold text-green-700">78%</span>
          </div>
        </div>
      </div>
    </div>
