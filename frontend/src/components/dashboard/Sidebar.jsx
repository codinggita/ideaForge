  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-[240px] bg-[#1E3A5F] flex flex-col py-6 px-4 z-50 hidden md:flex">
      ...
      <nav className="flex-1 space-y-1">
        <Link to="/dashboard" className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-white/10 text-white border-l-4 border-[#0B61A1] transition-colors font-medium text-sm tracking-[-0.02em]">
      ...
      <div className="mt-auto space-y-1 pt-6 border-t border-white/10">
        ...
        <Link to="#" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-300 hover:text-white hover:bg-white/5 transition-colors font-medium text-sm">
